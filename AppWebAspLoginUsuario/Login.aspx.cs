...
{    
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.ConnectionString = "Data Source=36DE250011\\SENAC;Initial Catalog=login;Integrated Security=True";
            /* Abertura da Conexão */
            con.Open();
        ...
        public void checkUser()
        {
            ...
            ds = new DataSet();
            /* Comando SQL */
            cmd.CommandText = "SELECT * FROM usuario WHERE email='" + txbemail.Text + "' AND senha='"+txbsenha.Text+"'";
            /* Conexão com Banco */
            cmd.Connection = con;
            ...
            if (check.HasRows)
            {
                ...
                string IdUserCookie = check["id_usuario"].ToString();
                // Preaparaçao para o Navegador
                HttpCookie id_usuario= new HttpCookie("id_usuario", IdUserCookie);
                // Inserção do cookie no navegador
                Response.Cookies.Add(id_usuario);                
